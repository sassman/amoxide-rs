...
<span class="line"><span>  ╰─ nr → npm run</span></span></code></pre></div><ul><li><a href="/usage/global.html">Global Aliases</a> — always-on aliases for every session</li><li><a href="/usage/profiles.html">Profiles</a> — managing named alias groups</li><li><a href="/usage/project-aliases.html">Project Aliases</a> — directory-scoped <code>.aliases</code> files</li><li><a href="/usage/subcommand-aliases.html">Subcommand Aliases</a> — short forms for subcommand-based tools</li><li><a href="/usage/sharing.html">Sharing</a> — export, import, and share with others</li></ul>`,7)])])}const m=a(p,[["render",i]]);export{h as __pageData,m as default};
