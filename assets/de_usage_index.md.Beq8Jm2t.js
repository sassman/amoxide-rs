...
<span class="line"><span>  ╰─ nr → npm run</span></span></code></pre></div>`,6)),n("ul",null,[e[4]||(e[4]=a('<li><a href="/de/usage/global">Globale Aliase</a> — immer verfügbare Aliase für jede Sitzung</li><li><a href="/de/usage/profiles">Profile</a> — benannte Alias-Gruppen verwalten</li><li><a href="/de/usage/project-aliases">Projekt-Aliase</a> — verzeichnisbezogene <code>.aliases</code>-Dateien</li><li><a href="/de/usage/subcommand-aliases">Subcommand-Aliase</a> — Kurzformen für subcommandbasierte Tools</li><li><a href="/de/usage/sharing">Teilen</a> — Aliase exportieren, importieren und teilen</li>',5)),n("li",null,[e[0]||(e[0]=n("code",null,"am ls -d",-1)),e[1]||(e[1]=i(" zeigt die Beschreibungsspalte, wenn Beschreibungen vorhanden sind ",-1)),l(s,{v:"0.10.0"})]),n("li",null,[e[2]||(e[2]=n("code",null,"am la",-1)),e[3]||(e[3]=i(" zeigt immer Beschreibungen für den aktiven Bereich ",-1)),l(s,{v:"0.10.0"})])])])}const v=p(d,[["render",c]]);export{_ as __pageData,v as default};
