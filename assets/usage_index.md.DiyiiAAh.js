...
<span class="line"><span>  ╰─ nr → npm run</span></span></code></pre></div><ul><li><a href="/usage/global">Global Aliases</a> — always-on aliases for every session</li><li><a href="/usage/profiles">Profiles</a> — managing named alias groups</li><li><a href="/usage/project-aliases">Project Aliases</a> — directory-scoped <code>.aliases</code> files</li><li><a href="/usage/subcommand-aliases">Subcommand Aliases</a> — short forms for subcommand-based tools</li><li><a href="/usage/sharing">Sharing</a> — export, import, and share with others</li></ul>`,7)])])}const h=a(p,[["render",i]]);export{u as __pageData,h as default};
