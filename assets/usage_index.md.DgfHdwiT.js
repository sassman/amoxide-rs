...
<span class="line"><span>  ╰─ nr → npm run</span></span></code></pre></div>`,6)),a("ul",null,[s[6]||(s[6]=a("li",null,[a("a",{href:"/usage/global"},"Global Aliases"),n(" — always-on aliases for every session")],-1)),s[7]||(s[7]=a("li",null,[a("a",{href:"/usage/profiles"},"Profiles"),n(" — managing named alias groups")],-1)),s[8]||(s[8]=a("li",null,[a("a",{href:"/usage/project-aliases"},"Project Aliases"),n(" — directory-scoped "),a("code",null,".aliases"),n(" files")],-1)),s[9]||(s[9]=a("li",null,[a("a",{href:"/usage/subcommand-aliases"},"Subcommand Aliases"),n(" — short forms for subcommand-based tools")],-1)),a("li",null,[s[0]||(s[0]=a("a",{href:"/usage/variables"},"Variables",-1)),s[1]||(s[1]=n(" — named placeholders shared across aliases ",-1)),l(e,{v:"0.9.0"})]),s[10]||(s[10]=a("li",null,[a("a",{href:"/usage/sharing"},"Sharing"),n(" — export, import, and share with others")],-1)),a("li",null,[s[2]||(s[2]=a("code",null,"am ls -d",-1)),s[3]||(s[3]=n(" shows the description column when descriptions are present ",-1)),l(e,{v:"0.10.0"})]),a("li",null,[s[4]||(s[4]=a("code",null,"am la",-1)),s[5]||(s[5]=n(" always shows descriptions for the active set ",-1)),l(e,{v:"0.10.0"})])])])}const y=o(d,[["render",c]]);export{v as __pageData,y as default};
