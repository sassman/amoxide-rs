...
3. **Registriert Tab-Vervollständigung** für Profil-, Alias-, Subcommand-Alias- und Variablennamen <VersionBadge v="0.10.0" />. Siehe [Shell-Vervollständigung](/de/advanced/shell-completion) für die Liste der Stellen.
