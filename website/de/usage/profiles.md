...
Mit `-d` lässt sich eine optionale Beschreibung anhängen: <VersionBadge v="0.10.0" />

```sh
am add -p rust ct "cargo test" -d "Test-Suite ausführen"
```

Zur Preserve-vs-Clear-Semantik von `-d` siehe [Globale Aliase](/de/usage/global).
