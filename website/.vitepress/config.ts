          ...
          '/advanced/': [
            {
              ...
              items: [
                ...
                { text: 'Shell Completion', link: '/advanced/shell-completion' },
                { text: 'Update Check', link: '/advanced/update-check' },
              ],
            },
          ],
          ...
          '/de/advanced/': [
            {
              ...
              items: [
                ...
                { text: 'Shell-Vervollständigung', link: '/de/advanced/shell-completion' },
                { text: 'Update-Prüfung', link: '/de/advanced/update-check' },
              ],
            },
          ],
