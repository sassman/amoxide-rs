...
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set list help" -s h -l help -d 'Print help'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set list help" -s V -l version -d 'Print version'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set list help" -f -a "add" -d 'Add a new profile'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set list help" -f -a "set" -d 'Set the active profile'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set list help" -f -a "list" -d 'List all profiles'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set list help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls profile init hook help" -f -a "init" -d 'Print shell init code (eval in your shell rc file)'
