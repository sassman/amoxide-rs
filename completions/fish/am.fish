...
complete -c am -n "__fish_am_needs_command" -f -a "import" -d 'Import aliases from stdin or a URL'
...
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "import" -d 'Import aliases from stdin or a URL'
