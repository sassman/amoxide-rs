...
complete -c am -n "__fish_am_using_subcommand export" -s p -l profile -d 'Export a specific profile' -r
complete -c am -n "__fish_am_using_subcommand export" -s l -l local -d 'Export only project-local aliases'
complete -c am -n "__fish_am_using_subcommand export" -s g -l global -d 'Export only global aliases'
complete -c am -n "__fish_am_using_subcommand export" -l all -d 'Export everything (global + all profiles + local)'
...
complete -c am -n "__fish_am_using_subcommand import" -s p -l profile -d 'Import into a specific profile' -r
complete -c am -n "__fish_am_using_subcommand import" -s l -l local -d 'Import into project-local aliases'
complete -c am -n "__fish_am_using_subcommand import" -s g -l global -d 'Import into global aliases'
