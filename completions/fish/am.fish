...
complete -c am -n "__fish_am_needs_command" -f -a "import" -d 'Import aliases from stdin'
...
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add use remove list help" -f -a "use" -d 'Toggle a profile as active/inactive, optionally at a specific priority'
...
complete -c am -n "__fish_am_using_subcommand profile; and __fish_seen_subcommand_from help" -f -a "use" -d 'Toggle a profile as active/inactive, optionally at a specific priority'
...
complete -c am -n "__fish_am_using_subcommand export" -s p -l profile -d 'Operate on a specific profile' -r
complete -c am -n "__fish_am_using_subcommand export" -s l -l local -d 'Operate on project-local aliases only'
complete -c am -n "__fish_am_using_subcommand export" -s g -l global -d 'Operate on global aliases only'
complete -c am -n "__fish_am_using_subcommand export" -l all -d 'Operate on everything (global + all profiles + local)'
complete -c am -n "__fish_am_using_subcommand export" -l base64 -d 'Encode output as base64'
...
complete -c am -n "__fish_am_using_subcommand import" -s p -l profile -d 'Operate on a specific profile' -r
complete -c am -n "__fish_am_using_subcommand import" -s l -l local -d 'Operate on project-local aliases only'
complete -c am -n "__fish_am_using_subcommand import" -s g -l global -d 'Operate on global aliases only'
complete -c am -n "__fish_am_using_subcommand import" -l all -d 'Operate on everything (global + all profiles + local)'
complete -c am -n "__fish_am_using_subcommand import" -l base64 -d 'Decode base64 input before parsing'
complete -c am -n "__fish_am_using_subcommand import" -s y -l yes -d 'Skip all confirmation prompts'
complete -c am -n "__fish_am_using_subcommand import" -l trust -d 'Acknowledge and accept potentially dangerous aliases (requires --yes)'
...
complete -c am -n "__fish_am_using_subcommand share" -s p -l profile -d 'Operate on a specific profile' -r
complete -c am -n "__fish_am_using_subcommand share" -s l -l local -d 'Operate on project-local aliases only'
complete -c am -n "__fish_am_using_subcommand share" -s g -l global -d 'Operate on global aliases only'
...
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "add" -d 'Add a new alias'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "remove" -d 'Remove an alias'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "ls" -d 'List all profiles and project aliases'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "status" -d 'Check if the shell is set up correctly'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "profile" -d 'Manage profiles (defaults to listing when no subcommand given)'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "init" -d 'Print shell init code'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "setup" -d 'Guided setup — adds amoxide to your shell profile'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "tui" -d 'Launch the interactive TUI for managing aliases and profiles'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "export" -d 'Export aliases to stdout as TOML'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "import" -d 'Import aliases from stdin'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "share" -d 'Generate a share command for posting aliases to a pastebin service'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "hook" -d 'Internal: called by the cd hook to load/unload project aliases'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "reload" -d 'Internal: called by the am wrapper to reload profile aliases after switching'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c am -n "__fish_am_using_subcommand help; and __fish_seen_subcommand_from profile" -f -a "add" -d 'Add a new profile'
complete -c am -n "__fish_am_using_subcommand help; and __fish_seen_subcommand_from profile" -f -a "use" -d 'Toggle a profile as active/inactive, optionally at a specific priority'
