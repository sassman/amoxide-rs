...
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui export import share hook reload help" -f -a "import" -d 'Import aliases from a URL or file'
