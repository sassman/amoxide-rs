...
complete -c am -n "__fish_am_needs_command" -f -a "la" -d 'List all active profiles and project aliases (always shows descriptions)'
...
complete -c am -n "__fish_am_needs_command" -f -a "var" -d 'Manage alias variables — substituted as `{{name}}` in alias commands'
...
complete -c am -n "__fish_am_needs_command" -f -a "__update-check" -d 'Internal: refresh the update-check cache from crates.io. Spawned detached by the listing commands; never invoked directly by users'
complete -c am -n "__fish_am_needs_command" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c am -n "__fish_am_using_subcommand add" -s p -l profile -d 'Operate on a specific profile (defaults to active profile)' -r
complete -c am -n "__fish_am_using_subcommand add" -s d -l description -d 'Optional description shown next to the alias in `am ls -d` and the TUI' -r
complete -c am -n "__fish_am_using_subcommand add" -l sub -d 'Define a subcommand alias (repeatable: --sub short long)' -r
complete -c am -n "__fish_am_using_subcommand add" -s l -l local -d 'Operate on the project\'s .aliases file'
complete -c am -n "__fish_am_using_subcommand add" -s g -l global -d 'Operate on global config'
...
complete -c am -n "__fish_am_using_subcommand remove" -s p -l profile -d 'Operate on a specific profile (defaults to active profile)' -r
...
complete -c am -n "__fish_am_using_subcommand remove" -s l -l local -d 'Operate on the project\'s .aliases file'
complete -c am -n "__fish_am_using_subcommand remove" -s g -l global -d 'Operate on global config'
...
complete -c am -n "__fish_am_using_subcommand ls" -s d -l descriptions -d 'Show descriptions next to aliases (when present)'
...
complete -c am -n "__fish_am_using_subcommand la" -s h -l help -d 'Print help'
complete -c am -n "__fish_am_using_subcommand la" -s V -l version -d 'Print version'
...
complete -c am -n "__fish_am_using_subcommand var; and not __fish_seen_subcommand_from set unset get list help" -s h -l help -d 'Print help'
complete -c am -n "__fish_am_using_subcommand var; and not __fish_seen_subcommand_from set unset get list help" -s V -l version -d 'Print version'
complete -c am -n "__fish_am_using_subcommand var; and not __fish_seen_subcommand_from set unset get list help" -f -a "set" -d 'Set a variable\'s value (upsert)'
complete -c am -n "__fish_am_using_subcommand var; and not __fish_seen_subcommand_from set unset get list help" -f -a "unset" -d 'Remove a variable'
complete -c am -n "__fish_am_using_subcommand var; and not __fish_seen_subcommand_from set unset get list help" -f -a "get" -d 'Print a variable\'s value'
complete -c am -n "__fish_am_using_subcommand var; and not __fish_seen_subcommand_from set unset get list help" -f -a "list" -d 'List variables (all scopes if no flag given)'
complete -c am -n "__fish_am_using_subcommand var; and not __fish_seen_subcommand_from set unset get list help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from set" -s p -l profile -d 'Operate on a specific profile (defaults to active profile)' -r
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from set" -s l -l local -d 'Operate on the project\'s .aliases file'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from set" -s g -l global -d 'Operate on global config'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from set" -s h -l help -d 'Print help'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from set" -s V -l version -d 'Print version'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from unset" -s p -l profile -d 'Operate on a specific profile (defaults to active profile)' -r
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from unset" -s l -l local -d 'Operate on the project\'s .aliases file'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from unset" -s g -l global -d 'Operate on global config'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from unset" -s h -l help -d 'Print help'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from unset" -s V -l version -d 'Print version'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from get" -s p -l profile -d 'Operate on a specific profile (defaults to active profile)' -r
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from get" -s l -l local -d 'Operate on the project\'s .aliases file'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from get" -s g -l global -d 'Operate on global config'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from get" -s h -l help -d 'Print help'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from get" -s V -l version -d 'Print version'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from list" -s p -l profile -d 'Operate on a specific profile (defaults to active profile)' -r
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from list" -s l -l local -d 'Operate on the project\'s .aliases file'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from list" -s g -l global -d 'Operate on global config'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from list" -s V -l version -d 'Print version'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from help" -f -a "set" -d 'Set a variable\'s value (upsert)'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from help" -f -a "unset" -d 'Remove a variable'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from help" -f -a "get" -d 'Print a variable\'s value'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from help" -f -a "list" -d 'List variables (all scopes if no flag given)'
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c am -n "__fish_am_using_subcommand __update-check" -s h -l help -d 'Print help'
complete -c am -n "__fish_am_using_subcommand __update-check" -s V -l version -d 'Print version'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "add" -d 'Add a new alias'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "remove" -d 'Remove an alias'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "ls" -d 'List all profiles and project aliases'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "la" -d 'List all active profiles and project aliases (always shows descriptions)'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "status" -d 'Check if the shell is set up correctly'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "profile" -d 'Manage profiles (defaults to listing when no subcommand given)'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "var" -d 'Manage alias variables — substituted as `{{name}}` in alias commands'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "init" -d 'Print shell init code'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "setup" -d 'Guided setup — adds amoxide to your shell profile'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "use" -d 'Shortcut for `am profile use` — toggle one or more profiles'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "tui" -d 'Launch the interactive TUI for managing aliases and profiles'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "export" -d 'Export aliases to stdout as TOML'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "import" -d 'Import aliases from a URL or file'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "share" -d 'Generate a share command for posting aliases to a pastebin service'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "trust" -d 'Review and trust the project .aliases file in the current directory'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "untrust" -d 'Remove trust for the project .aliases file in the current directory'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "sync" -d 'Internal: compute and emit the minimal shell ops to sync the shell with the effective merged alias state (global + profile + project)'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "__update-check" -d 'Internal: refresh the update-check cache from crates.io. Spawned detached by the listing commands; never invoked directly by users'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c am -n "__fish_am_using_subcommand help; and __fish_seen_subcommand_from var" -f -a "set" -d 'Set a variable\'s value (upsert)'
complete -c am -n "__fish_am_using_subcommand help; and __fish_seen_subcommand_from var" -f -a "unset" -d 'Remove a variable'
complete -c am -n "__fish_am_using_subcommand help; and __fish_seen_subcommand_from var" -f -a "get" -d 'Print a variable\'s value'
complete -c am -n "__fish_am_using_subcommand help; and __fish_seen_subcommand_from var" -f -a "list" -d 'List variables (all scopes if no flag given)'
