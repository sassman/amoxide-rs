...
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from set" -s g -l global -d 'Operate on global vars'
...
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from unset" -s g -l global -d 'Operate on global vars'
...
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from get" -s g -l global -d 'Operate on global vars'
...
complete -c am -n "__fish_am_using_subcommand var; and __fish_seen_subcommand_from list" -s g -l global -d 'Operate on global vars'
