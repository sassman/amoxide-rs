...
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set remove list help" -s h -l help -d 'Print help'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set remove list help" -s V -l version -d 'Print version'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set remove list help" -f -a "add" -d 'Add a new profile, or update inheritance of an existing one'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set remove list help" -f -a "set" -d 'Set the active profile'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set remove list help" -f -a "remove" -d 'Remove a profile'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set remove list help" -f -a "list" -d 'List all profiles'
complete -c am -n "__fish_am_using_subcommand profile; and not __fish_seen_subcommand_from add set remove list help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c am -n "__fish_am_using_subcommand profile; and __fish_seen_subcommand_from add" -s i -l inherits -d 'Base profile to inherit from' -r
complete -c am -n "__fish_am_using_subcommand profile; and __fish_seen_subcommand_from add" -l no-inherits -d 'Remove inheritance from this profile'
...
complete -c am -n "__fish_am_using_subcommand profile; and __fish_seen_subcommand_from set" -s h -l help -d 'Print help'
complete -c am -n "__fish_am_using_subcommand profile; and __fish_seen_subcommand_from set" -s V -l version -d 'Print version'
...
complete -c am -n "__fish_am_using_subcommand profile; and __fish_seen_subcommand_from help" -f -a "add" -d 'Add a new profile, or update inheritance of an existing one'
complete -c am -n "__fish_am_using_subcommand profile; and __fish_seen_subcommand_from help" -f -a "set" -d 'Set the active profile'
...
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "add" -d 'Add a new alias'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "remove" -d 'Remove an alias'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "ls" -d 'List all profiles and project aliases'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "status" -d 'Check if the shell is set up correctly'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "profile" -d 'Manage profiles (defaults to listing when no subcommand given)'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "init" -d 'Print shell init code'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "setup" -d 'Guided setup — adds amoxide to your shell profile'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "tui" -d 'Launch the interactive TUI for managing aliases and profiles'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "hook" -d 'Internal: called by the cd hook to load/unload project aliases'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "reload" -d 'Internal: called by the am wrapper to reload profile aliases after switching'
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls status profile init setup tui hook reload help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c am -n "__fish_am_using_subcommand help; and __fish_seen_subcommand_from profile" -f -a "add" -d 'Add a new profile, or update inheritance of an existing one'
complete -c am -n "__fish_am_using_subcommand help; and __fish_seen_subcommand_from profile" -f -a "set" -d 'Set the active profile'
