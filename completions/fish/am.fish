...
complete -c am -n "__fish_am_needs_command" -f -a "la" -d 'List all active profiles and project aliases'
...
complete -c am -n "__fish_am_using_subcommand help; and not __fish_seen_subcommand_from add remove ls la status profile var init setup use tui export import share trust untrust sync __update-check help" -f -a "la" -d 'List all active profiles and project aliases'
