...
complete -c sm -n "__fish_sm_needs_command" -f -a "init"
...
complete -c sm -n "__fish_sm_using_subcommand help; and not __fish_seen_subcommand_from add env init help" -f -a "init"
