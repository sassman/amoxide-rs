_am() {
    ...
    do
        case "${cmd},${i}" in
            ",$1")
                ...
                ;;
            am,__update-check)
                cmd="am__subcmd____update__subcmd__check"
                ;;
            am,add)
                cmd="am__subcmd__add"
                ;;
            am,context)
                cmd="am__subcmd__context"
                ;;
            am,export)
            ...
            am,var)
                cmd="am__subcmd__var"
                ;;
            am__subcmd__help,__update-check)
                cmd="am__subcmd__help__subcmd____update__subcmd__check"
                ;;
            am__subcmd__help,add)
                cmd="am__subcmd__help__subcmd__add"
                ;;
            am__subcmd__help,context)
                cmd="am__subcmd__help__subcmd__context"
                ;;
    ...
    case "${cmd}" in
        am)
            opts="-h -V --help --version add remove ls la status profile var init setup context use tui export import share trust untrust sync __update-check help"
            ...
            return 0
            ;;
        am__subcmd____update__subcmd__check)
            ...
            ;;
        am__subcmd__add)
            opts="-p -l -g -d -h -V --profile --local --global --raw --description --sub --help --version <NAME> [COMMAND]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        am__subcmd__export)
            ...
            ;;
        am__subcmd__help)
            opts="add remove ls la status profile var init setup context use tui export import share trust untrust sync __update-check help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        am__subcmd__help__subcmd____update__subcmd__check)
            opts=""
        ...
        am__subcmd__help__subcmd__add)
            ...
            return 0
            ;;
        am__subcmd__help__subcmd__context)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        am__subcmd__la)
            ...
            ;;
        am__subcmd__ls)
            opts="-u -d -h -V --used --descriptions --help --version"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
