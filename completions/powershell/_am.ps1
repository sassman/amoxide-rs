...
Register-ArgumentCompleter -Native -CommandName 'am' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'am' {
            ...
            [CompletionResult]::new('la', 'la', [CompletionResultType]::ParameterValue, 'List all active profiles and project aliases (always shows descriptions)')
            ...
            [CompletionResult]::new('context', 'context', [CompletionResultType]::ParameterValue, 'Print a model-friendly snapshot of the active alias set for AI coding assistants.')
        ...
        'am;ls' {
            ...
            [CompletionResult]::new('-d', '-d', [CompletionResultType]::ParameterName, 'Show descriptions next to aliases (when present)')
            [CompletionResult]::new('--descriptions', '--descriptions', [CompletionResultType]::ParameterName, 'Show descriptions next to aliases (when present)')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('-V', '-V ', [CompletionResultType]::ParameterName, 'Print version')
            [CompletionResult]::new('--version', '--version', [CompletionResultType]::ParameterName, 'Print version')
        ...
        'am;context' {
            [CompletionResult]::new('--setup', '--setup', [CompletionResultType]::ParameterName, 'Configure the named assistant''s session-start hook to call `am context`. Supported values: `claude`')
